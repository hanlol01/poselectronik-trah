	...
	<div class="table-responsive">
		<table class="table table-striped">
			<form action="fungsi/edit/edit.php?barang=edit" method="POST">
				...
				<tr>
					<td>Type Barang</td>
					<td><input type="text" class="form-control" value="<?php echo $hasil['type'];?>" name="type"></td>
				</tr>

				<tr>
					<td>Spesifikasi Barang</td>
					<td><input type="text" class="form-control" value="<?php echo $hasil['spesifikasi'];?>" name="spesifikasi"></td>
				</tr>
				<tr>
					<td>Warna Barang</td>
